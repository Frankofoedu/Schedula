...
public static b4a.example.add _add = null;
  public Object[] GetGlobals() {
		return new Object[] {"Add",Debug.moduleToString(b4a.example.add.class),"Main",Debug.moduleToString(b4a.example.main.class),"Messaging",Debug.moduleToString(b4a.example.messaging.class),"Service",starter.mostCurrent._service};
}
}